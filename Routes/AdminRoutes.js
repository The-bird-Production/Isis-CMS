...
router.post('/pics.send', securite,upload.single('pics'), AdminControllers.pics_send)
...
router.post('/file.send', securite, upload.single('file'), AdminControllers.docs_send)
