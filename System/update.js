...
async function backupDatabase() {
  return new Promise((resolve, reject) => {
    const backupQuery = "mysqldump -u " + config.db_user +  " -p" + config.db_password + " " + config.db_name + " > backup.sql -t";
...
async function updateModele() {
  return new Promise((resolve, reject) => {
    ...
    modele_importer.import('./update/modele.sql').then(()=>{
...
async function restoreBackup() {
  return new Promise((resolve, reject) => {
    ...
    backup_importer.import('./backup.sql').then(()=>{
